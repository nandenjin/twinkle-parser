...
describe('parse', () => {
  ...
  test('Multi terms', () => {
    const csv = '"0000000","","","","","秋ABC","","","","","","","","","0000000","",""'
    const parsed: KDBData = {
      '0000000': {
        title: '',
        termStr: '秋ABC',
  ...
  test('Multi periods', () => {
    const csv = '"0000000","","","","","","月1-6","","","","","","","","0000000","",""'
    const parsed: KDBData = {
      '0000000': {
        title: '',
        termStr: '',
  ...
  test('Multi periods series', () => {
    // One day for one line
    {
      ...
      const parsed: KDBData = {
        '0000000': {
          ...
          terms: [],
          periodStr: '月1-6\n水2-5\n土3-4',
          periods: [[[1], [0, 1, 2, 3, 4, 5]], [[3], [1, 2, 3, 4]], [[6], [2, 3]]],
          rooms: [],
          instructors: [],
          overview: '',
          remarks: ''
    ...
    {
      const csv = '"0000000","","","","","","月金1-6","","","","","","","","0000000","",""'
      const parsed: KDBData = {
        '0000000': {
          title: '',
          termStr: '',
    ...
    // Mixed and unsorted
    {
      ...
      const parsed: KDBData = {
        '0000000': {
          ...
          terms: [],
          periodStr: '水火1-6\n土2-4',
          periods: [[[2, 3], [0, 1, 2, 3, 4, 5]], [[6], [1, 2, 3]]],
          rooms: [],
          instructors: [],
          overview: '',
          remarks: ''
  ...
  test('Return empty array for unparsable term string', () => {
    const csv = '"0000000","","","","","開講モジュール","","","","","","","","","0000000","",""'
    const parsed: KDBData = {
      '0000000': {
        title: '',
        termStr: '開講モジュール',
  ...
  test('Return empty array for unparsable period string', () => {
    const csv = '"0000000","","","","","","開講時限","","","","","","","","0000000","",""'
    const parsed: KDBData = {
      '0000000': {
        title: '',
        termStr: '',
