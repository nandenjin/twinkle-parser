...
describe('parse', () => {
  test('Basic', () => {
    const csv =
      '"0000000","授業名","1","1.0","1・2","春A","月1","1H101","教員名","概要","備考","","","Title in English","0000000","授業名",""'
